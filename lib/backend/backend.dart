...
/// Functions to query UserExpendituresRecords (as a Stream and as a Future).
Future<int> queryUserExpendituresRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
...
Stream<List<UserExpendituresRecord>> queryUserExpendituresRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<UserExpendituresRecord>> queryUserExpendituresRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
